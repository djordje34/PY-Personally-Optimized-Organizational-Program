...
__all__ = [
    'SP_VISEME_13', 'DISPID_SpeechPhraseReplacement', 'LONG_PTR',
    'SPSFunction', 'eLEXTYPE_PRIVATE4', 'SASClosed',
    'DISPID_SRCreateRecoContext', 'DISPID_SPRuleParent',
    'DISPID_SVSkip', 'SECFIgnoreKanaType', '_SPAUDIOSTATE',
    'SpNotifyTranslator', 'SPEI_UNDEFINED', 'SDTReplacement',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPLOADOPTIONS',
    'DISPID_SLPSymbolic', 'ISpeechPhraseProperties',
    'SAFT11kHz8BitMono', 'DISPID_SVSpeakStream', 'DISPID_SOTCSetId',
    'DISPID_SpeechCustomStream', 'DISPID_SPEActualConfidence',
    'DISPID_SRCERecognizerStateChange', 'SPVISEMES', 'SREStreamEnd',
    'DISPID_SPRuleName', 'DISPID_SRIsShared', 'ISpObjectToken',
    'ISpRecognizer2', 'DISPID_SRCESoundEnd', 'SECHighConfidence',
    'DISPID_SGRsItem', 'SVP_11', 'tagSPTEXTSELECTIONINFO',
    'SPDKL_CurrentUser', 'SpeechRecognitionType', 'DISPID_SVVolume',
    'SPCT_SUB_COMMAND', 'Speech_Max_Word_Length',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SABIMinNotification', 'SPVOICESTATUS', 'SPEI_SR_BOOKMARK',
    'SPPS_Unknown', 'DISPID_SOTCEnumerateTokens',
    'SSFMCreateForWrite', 'SFTInput', 'DISPID_SpeechPhraseProperty',
    'DISPID_SFSClose', 'SRCS_Disabled', 'DISPID_SGRSTPropertyValue',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SVEBookmark', 'SINone',
    'DISPID_SDKGetlongValue', 'SRSEIsSpeaking', 'SpMMAudioOut',
    'SVSFNLPSpeakPunc', 'DISPID_SGRsFindRule', 'STCRemoteServer',
    'SPPHRASE', 'SpeechVoiceCategoryTTSRate', 'SPVPRI_OVER',
    'DISPID_SMSGetData', 'SAFT8kHz8BitMono', 'SGRSTTEpsilon',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SVEAudioLevel', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SAFT32kHz8BitMono', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRRSetTextFeedback', 'SPCT_SUB_DICTATION', 'ISpVoice',
    'SPSNoun', 'DISPID_SpeechXMLRecoResult',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPPHRASEREPLACEMENT', 'SDTRule',
    'SPEI_ADAPTATION', 'SAFTNoAssignedFormat',
    'DISPID_SRSClsidEngine', 'SSFMOpenReadWrite',
    'DISPID_SpeechGrammarRule', 'DISPID_SAStatus', 'WAVEFORMATEX',
    'DISPID_SLPsCount', 'SAFTADPCM_11kHzStereo',
    'SpeechRegistryUserRoot', 'DISPID_SGRsCount',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechAudioFormatType',
    'DISPID_SVSpeakCompleteEvent', 'STCAll', 'SREAdaptation',
    'SASRun', 'SPEI_HYPOTHESIS', 'DISPID_SGRs_NewEnum',
    'ISpeechXMLRecoResult', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SVEEnginePrivate', 'SRTAutopause', 'SPPS_Noun',
    'SINoSignal', 'SRSInactive', 'SVF_Emphasis',
    'SREFalseRecognition', 'DISPID_SLWLangId',
    'DISPID_SVWaitUntilDone', 'SAFT44kHz16BitStereo',
    'DISPID_SVSLastStreamNumberQueued', 'SVP_9', 'ISpLexicon',
    'SPWT_PRONUNCIATION', 'SAFT24kHz8BitMono', 'STCInprocHandler',
    'SREHypothesis', 'ISpStreamFormat', 'eLEXTYPE_PRIVATE12',
    'eLEXTYPE_PRIVATE15', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechPhraseInfo', 'SPPS_Modifier', 'ISpeechFileStream',
    'SVP_8', 'DISPID_SOTIsUISupported', 'SpeechVoicePriority',
    'SpeechVisemeType', 'SRSInactiveWithPurge', 'SPEI_RECOGNITION',
    'SPSSuppressWord', 'SpObjectToken', 'DISPID_SPIAudioSizeBytes',
    'eLEXTYPE_RESERVED9', 'DISPID_SVSPhonemeId',
    'SpeechVoiceSpeakFlags', 'DISPID_SRRTLength',
    'eLEXTYPE_RESERVED8', 'ISpPhoneticAlphabetSelection',
    'SPPS_RESERVED3', 'eLEXTYPE_PRIVATE3', 'ISpeechCustomStream',
    'DISPID_SMSADeviceId', 'DISPID_SVSInputSentenceLength',
    'SpMMAudioIn', 'DISPID_SGRSTPropertyName',
    'DISPID_SADefaultFormat', 'SRSEDone',
    'DISPID_SLRemovePronunciation', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFT8kHz16BitStereo', 'ISpeechAudioFormat', 'SpeechFormatType',
    'Speech_StreamPos_RealTime', 'SAFT44kHz8BitStereo',
    ...
    'DISPID_SPPsItem', 'SPRECOSTATE', 'DISPID_SPIAudioSizeTime',
    'SpMemoryStream', 'DISPID_SPPParent', 'SAFTGSM610_8kHzMono',
    'SREStateChange', 'DISPID_SVESentenceBoundary',
    'ISpeechRecoResultTimes', 'DISPID_SPRNumberOfElements',
    'SRAInterpreter', 'SPEI_RESERVED3', 'SAFT48kHz16BitMono',
    'DISPID_SWFESamplesPerSec', 'SAFTGSM610_11kHzMono',
    'SGPronounciation', 'DISPID_SLWsCount',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpStreamFormatConverter',
    'SpeechCategoryVoices', 'DISPID_SPELexicalForm',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRAddState',
    'SRESoundEnd', 'SPEI_RESERVED2', 'SRATopLevel',
    'SpeechEngineConfidence', 'ISpeechPhraseReplacements',
    'DISPID_SVStatus', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRAudioInputStream', 'SRAImport',
    'DISPID_SRRSaveToMemory', 'DISPID_SPIEnginePrivateData',
    'eLEXTYPE_RESERVED10', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'IEnumSpObjectTokens', 'DISPID_SABufferNotifySize',
    'ISpeechLexicon', 'SPBO_NONE', 'SDA_No_Trailing_Space',
    'DISPID_SRGRules', 'SpResourceManager', 'SGLexical',
    ...
    'DISPID_SAFGuid', 'ISequentialStream', 'DISPID_SRGetFormat',
    'SVSFIsNotXML', 'SPAR_High', 'DISPID_SRSCurrentStreamNumber',
    'SVSFlagsAsync', 'SECFNoSpecialChars', 'DISPID_SRRAudio',
    'SPEI_SR_RETAINEDAUDIO', 'SECFEmulateResult', 'SVP_21', 'SPEVENT',
    'SPAS_STOP', 'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SMSAMMHandle',
    'DISPID_SVEVoiceChange', 'SpeechSpecialTransitionType',
    'DISPID_SVRate', 'SPSMF_UPS', 'DISPID_SRGetPropertyNumber',
    'SVP_6', 'SpeechStreamFileMode', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SDKCreateKey', 'eLEXTYPE_PRIVATE19', 'SPGRAMMARSTATE',
    'SPFM_NUM_MODES', 'DISPID_SPCLangId', 'DISPID_SGRsCommit',
    'DISPID_SRGDictationLoad', 'DISPID_SOTs_NewEnum',
    'ISpNotifyTranslator', 'ISpeechWaveFormatEx', 'SPSUnknown',
    'SP_VISEME_9', 'SDTDisplayText', 'SRSActive',
    'SPTEXTSELECTIONINFO', 'SRAONone', 'SpSharedRecoContext',
    ...
    'SPPS_NotOverriden', 'SDTPronunciation', 'SGRSTTTextBuffer',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SREAudioLevel',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRState', 'SpeechTokenKeyFiles',
    'SP_VISEME_5', 'SPRULESTATE', 'DISPID_SGRsCommitAndSave',
    'SVEPrivate', 'SPEI_REQUEST_UI', 'DISPID_SVPause',
    'SpeechEmulationCompareFlags', 'DISPID_SRRRecoContext',
    'DISPID_SOTCreateInstance', 'DISPID_SGRSAddWordTransition',
    'SPEI_VISEME', 'SVEAudioLevel', 'DISPID_SRSetPropertyNumber',
    'SRADynamic', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_MIN_SR',
    'DISPID_SLAddPronunciation', 'SPWORD', 'SAFT11kHz16BitMono',
    'SAFTADPCM_22kHzStereo', 'ISpeechRecoResultDispatch',
    'SAFT48kHz8BitMono', 'SDKLLocalMachine',
    'DISPID_SASNonBlockingIO', 'SpShortcut', 'ISpObjectWithToken',
    'SVSFParseSapi', 'DISPID_SLGetGenerationChange',
    'SpeechRuleAttributes', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SGRSTText', 'DISPID_SLPsItem',
    'DISPIDSPTSI_SelectionOffset', 'SP_VISEME_19',
    'DISPID_SVSRunningState', 'SPPS_SuppressWord',
    'eLEXTYPE_PRIVATE7', 'SPGS_DISABLED', 'ISpeechPhraseElements',
    'SP_VISEME_16', 'SPEI_RESERVED1', 'SVSFIsFilename',
    'SpMMAudioEnum', 'SPFM_CREATE_ALWAYS', 'SAFTExtendedAudioFormat',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechBaseStream',
    'SAFTCCITT_ALaw_44kHzStereo', 'SVP_2', 'SRESoundStart',
    'DISPID_SVSInputWordLength', 'DISPID_SPIGetText',
    'DISPID_SGRAddResource', 'DISPID_SLPType', 'SP_VISEME_12',
    'DISPID_SLPLangId', 'eLEXTYPE_PRIVATE6', 'ISpeechPhraseRule',
    'SITooLoud', 'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechAudioFormat', 'SPSERIALIZEDPHRASE', 'SPVPRI_NORMAL',
    'SRERecoOtherContext', 'DISPID_SPPName', 'SDKLDefaultLocation',
    'ISpeechLexiconWord', 'SSSPTRelativeToStart',
    'DISPID_SRCCmdMaxAlternates', 'SVPNormal', 'SVSFParseSsml',
    'SVP_17', 'DISPID_SRGSetWordSequenceData', 'SVP_0',
    'SpeechPropertyResponseSpeed', 'SAFT16kHz16BitMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPRs_NewEnum', 'SRTReSent',
    'DISPID_SpeechPhraseRules', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPAStartElementInResult', 'ISpRecoContext2', 'SGRSTTWord',
    'DISPID_SRCEEndStream', 'DISPID_SAFType', 'SVEBookmark',
    'SPAR_Unknown', 'SPDKL_DefaultLocation',
    'DISPID_SOTMatchesAttributes', 'SPWT_LEXICAL',
    'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPRuleEngineConfidence', 'ISpeechGrammarRuleState',
    'DISPID_SRCRetainedAudioFormat', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechCategoryRecognizers', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPPROPERTYINFO', 'DISPID_SPEs_NewEnum',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRCSetAdaptationData',
    'SGRSTTRule', 'SpeechCategoryAudioIn', 'DISPID_SVVoice',
    'DISPID_SPIGrammarId', 'DISPID_SWFEBlockAlign', 'SPFILEMODE',
    'DISPID_SLGenerationId', 'eLEXTYPE_PRIVATE20',
    'ISpeechPhraseProperty', 'DISPID_SPPId', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRStatus', 'Speech_Max_Pron_Length',
    ...
    'SPSHORTCUTTYPE', 'ISpeechVoiceStatus', 'SpVoice',
    'SPCT_DICTATION', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpPhraseAlt', 'SVP_19',
    'SGRSTTDictation', 'SPCONTEXTSTATE', 'DISPID_SGRClear',
    'DISPID_SPACommit', 'SP_VISEME_15', 'DISPID_SVEStreamStart',
    'SVSFParseMask', 'SPEI_TTS_AUDIO_LEVEL', 'SAFT8kHz16BitMono',
    'DISPID_SRCPause', 'SVPOver', 'DISPID_SVGetVoices',
    'SPRST_ACTIVE', 'DISPID_SPILanguageId', 'STSF_FlagCreate',
    'SP_VISEME_18', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SVAudioOutput', 'DISPID_SDKEnumValues',
    'DISPID_SRGetRecognizers', 'SPRST_INACTIVE',
    'DISPID_SABIEventBias', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'eWORDTYPE_ADDED', 'DISPID_SRRAlternates',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPEPronunciation',
    'DISPID_SOTGetAttribute', 'DISPID_SABufferInfo', 'SVP_3',
    'SPPHRASEELEMENT', 'SDA_Consume_Leading_Spaces', 'SPAUDIOOPTIONS',
    'SAFTCCITT_uLaw_44kHzStereo', '_ISpeechVoiceEvents',
    'SRTEmulated', 'DISPID_SPANumberOfElementsInResult',
    'SPEI_MAX_TTS', 'SVP_7', 'SAFTDefault', 'ISpeechPhraseAlternates',
    'DISPID_SPAsCount', 'DISPID_SOTsCount', 'SPSVerb', 'SASStop',
    'SPEI_MIN_TTS', 'SVEWordBoundary', 'ISpeechRecognizerStatus',
    'DISPID_SPIProperties', 'SpeechWordPronounceable', 'SPVPRI_ALERT',
    'DISPID_SpeechGrammarRules', 'SAFT12kHz16BitMono',
    'SAFT22kHz16BitMono', 'SVEViseme', 'SREInterference',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRGetPropertyString',
    'DISPID_SVPriority', 'SPGS_EXCLUSIVE', 'SPINTERFERENCE_TOOLOUD',
    'SVEPhoneme', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechPhraseReplacements', 'SPCS_DISABLED',
    'DISPID_SVSLastBookmark', 'ISpeechGrammarRule',
    'DISPID_SRRPhraseInfo', 'SGSExclusive', 'DISPID_SGRSTs_NewEnum',
    'SpeechInterference', 'SPAR_Low',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechMMSysAudio',
    'SECFDefault', 'DISPID_SRCERecognition',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SLWs_NewEnum',
    'SGDSInactive', 'ISpSerializeState', 'SPPS_Verb', 'SP_VISEME_14',
    'DISPID_SVSInputWordPosition', 'eLEXTYPE_USER',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPARecoResult',
    'SpCompressedLexicon', 'eLEXTYPE_PRIVATE8',
    'DISPID_SDKSetBinaryValue', 'SGDSActiveUserDelimited',
    'SPAS_CLOSED', 'SITooSlow', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPPChildren', 'ISpeechLexiconPronunciations',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPIReplacements',
    'SPSHT_Unknown', 'SpFileStream', 'DISPID_SRCEHypothesis',
    'DISPID_SPERetainedSizeBytes', 'ISpeechResourceLoader',
    'SPEI_START_SR_STREAM', 'SPGS_ENABLED', 'SPEI_INTERFERENCE',
    'DISPID_SRAudioInput', 'ISpeechRecoContext', 'DISPID_SpeechAudio',
    'DISPID_SLWWord', 'SFTSREngine', 'eLEXTYPE_RESERVED7',
    'Speech_StreamPos_Asap', 'DISPID_SAVolume', 'SPGRAMMARWORDTYPE',
    ...
    'DISPID_SGRSTType', 'DISPID_SPRulesItem', 'tagSPPROPERTYINFO',
    ...
    'SREPhraseStart', 'SRERecognition', 'SPCS_ENABLED',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEVENTSOURCEINFO',
    'SpPhoneticAlphabetConverter', 'IStream', 'ISpGrammarBuilder',
    'ISpeechPhraseElement', 'DISPID_SRCEPhraseStart',
    'DISPID_SPIElements', 'eLEXTYPE_VENDORLEXICON',
    'SREPropertyStringChange', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRCEAdaptation', 'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechDataKey', 'SpeechRecoEvents', 'SDKLCurrentConfig',
    'SpeechPropertyHighConfidenceThreshold', 'SVSFVoiceMask',
    'eLEXTYPE_RESERVED4', 'SPPARTOFSPEECH', 'DISPID_SPRText',
    'SVEEndInputStream', 'SpeechPropertyNormalConfidenceThreshold',
    'SPXRO_SML', 'ISpeechVoice', 'SPBO_TIME_UNITS', 'DISPIDSPTSI',
    'SDA_Two_Trailing_Spaces', 'ISpNotifySource', 'DISPID_SGRsAdd',
    'SpeechRetainedAudioOptions', 'SPPS_RESERVED4', 'SPSHT_EMAIL',
    'DISPID_SRCERequestUI', 'eLEXTYPE_RESERVED6',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPINTERFERENCE', 'ISpRecognizer3',
    'DISPID_SPEDisplayText', 'DISPID_SGRSTransitions',
    'SpeechPropertyAdaptationOn', 'DISPID_SRCRecognizer',
    'SPAS_PAUSE', 'DISPID_SRCEBookmark',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPPFirstElement',
    'SPBO_PAUSE', 'DISPIDSPRG', 'eLEXTYPE_USER_SHORTCUT',
    'SpWaveFormatEx', 'SpeechBookmarkOptions',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SLGetPronunciations',
    'DISPID_SpeechLexicon', 'SPSLMA',
    'ISpeechTextSelectionInformation', 'SSSPTRelativeToEnd',
    'DISPID_SRCState', 'DISPID_SOTCGetDataKey',
    'SPEI_START_INPUT_STREAM', 'ISpeechLexiconWords',
    'DISPID_SRGCmdLoadFromObject', 'SpeechAudioProperties',
    'SGDSActiveWithAutoPause', 'DISPID_SOTCId', 'UINT_PTR',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRRecognizer', 'DISPID_SVEWord',
    'DISPID_SLWPronunciations', 'DISPID_SRDisplayUI',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpRecoCategory',
    ...
    'SPEI_RECO_STATE_CHANGE', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRRSpeakAudio', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRIsUISupported', 'DISPID_SDKDeleteKey',
    'DISPID_SPEsCount', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechLexiconWord',
    'SITooQuiet', 'SPPS_LMA', 'STCInprocServer', 'SVP_18',
    'ISpStreamFormatConverter', 'ISpeechGrammarRuleStateTransition',
    'SpeechTokenValueCLSID', 'SpInProcRecoContext',
    'SAFT32kHz8BitStereo', 'SPWF_INPUT', 'DISPID_SpeechPhraseRule',
    'SPXMLRESULTOPTIONS', 'SPPS_RESERVED2', 'DISPID_SVSVisemeId',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPPValue',
    'ISpeechObjectToken', 'SPDKL_CurrentConfig', 'SAFT8kHz8BitStereo',
    'DISPID_SpeechVoiceStatus', 'DISPID_SGRInitialState',
    'SPCATEGORYTYPE', 'DISPID_SLWsItem', 'ISpeechPhraseInfoBuilder',
    'SpLexicon', 'SRTStandard', 'STCLocalServer',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPSMF_SAPI_PROPERTIES', 'SGSDisabled', 'DISPID_SGRsDynamic',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SDKDeleteValue',
    'SpeechVisemeFeature', 'DISPID_SPIStartTime',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_PRIVATE16',
    'SREStreamStart', 'SpeechGrammarTagDictation',
    'DISPID_SPRulesCount', 'SpSharedRecognizer', 'eLEXTYPE_PRIVATE18',
    'eLEXTYPE_PRIVATE9', 'SRAExport', 'DISPID_SPRsCount', 'SITooFast',
    'DISPID_SRCRetainedAudio', 'SAFT32kHz16BitMono',
    'DISPID_SOTDisplayUI', 'SWPKnownWordPronounceable',
    'SAFT16kHz16BitStereo', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SpeechPhraseElement', 'DISPID_SASState',
    'DISPID_SRCESoundStart', 'ISpRecoGrammar', 'SVPAlert',
    'SRSActiveAlways', 'SGSEnabled', 'DISPID_SRCRequestedUIType',
    'DISPID_SRGReset', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFTADPCM_22kHzMono', 'DISPID_SVDisplayUI', 'SP_VISEME_20',
    'SAFT12kHz8BitStereo', 'DISPID_SRRGetXMLResult',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVSLastResult',
    'DISPID_SRGIsPronounceable', 'ISpEventSource',
    'DISPID_SDKSetLongValue', 'DISPID_SRSSupportedLanguages',
    'SAFTGSM610_22kHzMono', 'DISPID_SLPs_NewEnum',
    'SPRECORESULTTIMES', 'DISPID_SGRAttributes', 'SPFM_CREATE',
    'SVP_20', 'SWPUnknownWordUnpronounceable', 'SREBookmark',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpRecoContext',
    'DISPID_SRGState', 'STSF_AppData', 'SpObjectTokenCategory',
    'SpeechCategoryRecoProfiles', 'SPEI_RESERVED5',
    'DISPID_SpeechLexiconProns', 'SPRST_ACTIVE_ALWAYS',
    'SPPS_Interjection', 'DISPID_SRCEEnginePrivate', 'SPSHT_OTHER',
    'DISPID_SVSpeak', 'SpeechStreamSeekPositionType', 'SREAllEvents',
    'SpeechVoiceEvents', 'DISPID_SWFEChannels',
    'DISPID_SVSLastBookmarkId',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPFM_OPEN_READONLY', 'DISPID_SpeechMemoryStream',
    'SAFT11kHz8BitStereo', 'SP_VISEME_10', 'ISpRecoResult',
    'DISPID_SPISaveToMemory', 'SP_VISEME_7', 'SpeechDataKeyLocation',
    'ISpeechAudio', 'DISPID_SOTCategory', 'SECNormalConfidence',
    'DISPID_SOTId', 'ISpResourceManager',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRGCmdLoadFromFile',
    'SPSEMANTICFORMAT', 'DISPID_SLGetWords', 'DISPID_SPPsCount',
    'SVSFPersistXML', 'SVF_None', 'ISpObjectTokenCategory',
    'SPBO_AHEAD', 'DISPID_SVSInputSentencePosition', 'ISpNotifySink',
    'ISpShortcut', 'DISPID_SBSWrite', 'DISPID_SRGCmdSetRuleState',
    'SP_VISEME_17', 'SpNullPhoneConverter', 'DISPID_SVEPhoneme',
    'ISpeechDataKey', 'DISPID_SDKGetStringValue', 'SPVPRIORITY',
    'SAFT24kHz8BitStereo', 'DISPID_SVEViseme', 'ISpAudio',
    'SpeechTokenIdUserLexicon', 'SPEI_TTS_PRIVATE',
    'STSF_LocalAppData', 'SPDKL_LocalMachine', 'SVP_10',
    'DISPID_SDKEnumKeys', 'DISPID_SPPs_NewEnum', 'SP_VISEME_1',
    'SPEVENTENUM', 'DISPID_SRCResume', 'DISPID_SpeechRecoContext',
    'ISpeechAudioStatus', 'DISPID_SPEDisplayAttributes',
    'SAFT44kHz16BitMono', 'SDTAlternates', 'DISPID_SPEAudioSizeTime',
    'SECFIgnoreWidth', 'SpeechAddRemoveWord', 'SVP_4',
    'SPDATAKEYLOCATION', 'SPRECOGNIZERSTATUS', 'SSFMCreate',
    'DISPID_SASCurrentDevicePosition', 'eLEXTYPE_PRIVATE1',
    'DISPID_SWFEFormatTag', 'DISPID_SOTSetId',
    'DISPID_SRRGetXMLErrorInfo', 'ISpDataKey', 'SWTAdded',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechLexiconType',
    'SPEI_VOICE_CHANGE', 'SVSFParseAutodetect', 'ISpeechRecoGrammar',
    'DISPID_SGRSTNextState', 'DISPID_SLPPartOfSpeech',
    'SpeechAudioFormatGUIDWave', 'SPXRO_Alternates_SML',
    'ISpeechRecoResult2', 'SpTextSelectionInformation', 'SDTAudio',
    'DISPID_SGRSTsItem', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechWaveFormatEx', 'SP_VISEME_21',
    'DISPID_SPAPhraseInfo', 'SREPrivate', 'SPRST_NUM_STATES',
    'SASPause', 'ISpRecognizer', 'SSTTDictation',
    'ISpeechMemoryStream', 'SAFT16kHz8BitMono',
    'DISPID_SRCEventInterests', 'SPEI_END_SR_STREAM',
    'DISPID_SRCEAudioLevel', 'DISPID_SPRuleChildren', 'SPEI_MAX_SR',
    'SPINTERFERENCE_TOOSLOW', 'ISpPhoneConverter', 'SP_VISEME_0',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVAudioOutputStream', 'SINoise', 'SPAUDIOSTATE',
    'SpeechGrammarRuleStateTransitionType', 'SSTTTextBuffer',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechCategoryAppLexicons', 'SVP_14',
    'SVEStartInputStream', 'ISpeechRecognizer', 'DISPID_SGRId',
    'DISPID_SVGetProfiles', 'DISPID_SOTDataKey', 'SPBINARYGRAMMAR',
    'SAFT11kHz16BitStereo', 'SPWAVEFORMATTYPE', 'SPLO_STATIC',
    'SDTProperty', 'SP_VISEME_11', 'eLEXTYPE_PRIVATE10', 'SPRULE',
    'SpeechRecognizerState', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SpeechRecognizerStatus', 'SLTApp',
    'IInternetSecurityMgrSite', 'SpeechAllElements',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPAsItem', 'SPSModifier',
    'SpeechGrammarState', 'DISPID_SPEAudioTimeOffset', 'SPCT_COMMAND',
    'ISpeechLexiconPronunciation', 'SLTUser',
    'SpeechRecoContextState', 'ISpPhrase', 'SP_VISEME_4',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPPNumberOfElements',
    'ISpeechPhraseAlternate', 'SPEI_SR_PRIVATE', 'SPWT_DISPLAY',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SWFEExtraData',
    'eLEXTYPE_APP', 'SDTAll', 'SP_VISEME_8',
    'DISPID_SRGDictationUnload', 'DISPID_SPIGetDisplayAttributes',
    'SAFTADPCM_44kHzStereo', 'SAFT48kHz8BitStereo',
    'DISPID_SPCPhoneToId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_2',
    'SWTDeleted', 'SPINTERFERENCE_NONE', 'DISPID_SBSRead',
    'DISPID_SPRules_NewEnum', 'DISPID_SRRTTickCount',
    'SPSHORTCUTPAIR', 'SVP_16', 'ISpProperties', 'SPWORDLIST',
    'SBONone', 'SSFMOpenForRead', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SVEVoiceChange', 'SVP_1', 'SAFT22kHz8BitMono', 'ISpEventSink',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechAudioState',
    'DISPID_SpeechObjectToken', 'DISPID_SOTCDefault',
    'DISPID_SPRuleFirstElement', 'SVP_12',
    'SpeechAudioFormatGUIDText', 'ISpeechBaseStream', 'SBOPause',
    'SECFIgnoreCase', 'SPSInterjection', 'SpeechTokenKeyAttributes',
    'SAFT12kHz16BitStereo', 'SRERequestUI',
    'DISPID_SGRSAddSpecialTransition', 'SAFT22kHz16BitStereo',
    'SPAUDIOSTATUS', 'DISPID_SRCVoice',
    'DISPID_SPERequiredConfidence', 'DISPID_SWFEBitsPerSample',
    'SGDSActive', 'DISPID_SRCEInterference', 'SVEAllEvents',
    'SPLO_DYNAMIC', 'DISPID_SOTsItem', 'eWORDTYPE_DELETED',
    'eLEXTYPE_PRIVATE13', 'DISPID_SWFEAvgBytesPerSec', 'SVSFNLPMask',
    'SpCustomStream', 'SPPHRASEPROPERTY', 'SAFT48kHz16BitStereo',
    ...
    'SAFTADPCM_44kHzMono', 'SPRS_INACTIVE', 'DISPID_SRProfile',
    'SDA_One_Trailing_Space', 'DISPID_SASetState',
    'SREPropertyNumChange', 'SRCS_Enabled', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRRAudioFormat', 'SpeechTokenShellFolder',
    'SDTLexicalForm', 'SECLowConfidence', 'eLEXTYPE_PRIVATE14',
    'SLOStatic', 'SPAUDIOBUFFERINFO', 'IEnumString',
    ...
    'DISPID_SGRSTWeight', 'SpeechTokenContext', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCVoicePurgeEvent', '__MIDL_IWinTypes_0009',
    ...
    'SRAORetainAudio', 'SAFT24kHz16BitMono', 'SPEI_SOUND_START',
    'SPSNotOverriden', 'SRTSMLTimeout', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRCEStartStream', 'ISpeechAudioBufferInfo',
    'DISPID_SRGCmdLoadFromResource', 'SPAS_RUN', 'SPEI_RESERVED6',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVEventInterests',
    'DISPID_SpeechRecoResultTimes', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPEsItem', 'SPCT_SLEEP',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFT44kHz8BitMono',
    'DISPID_SPRuleId', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SGRName', 'SpeechTokenKeyUI', 'SpAudioFormat',
    'DISPID_SPIEngineId', 'DISPID_SRGId', 'DISPID_SMSSetData',
    'DISPID_SPCIdToPhone', 'SPEI_PHONEME', 'SPEI_SOUND_END',
    'SVSFDefault', 'ISpeechObjectTokenCategory',
    'SpeechGrammarWordType', 'SpeechDisplayAttributes',
    'SGRSTTWildcard', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPRsItem', 'DISPID_SOTRemove',
    'SpeechRecoProfileProperties', 'SPPS_Noncontent',
    'SpeechCategoryAudioOut', 'SAFTADPCM_8kHzMono',
    'SPAO_RETAIN_AUDIO', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SpeechAudioStatus', 'SAFT12kHz8BitMono',
    'DISPID_SGRSRule', 'DISPID_SAEventHandle', 'SpeechMicTraining',
    'SSTTWildcard', 'SPAR_Medium', 'SRARoot', 'SRADefaultToActive',
    'SLODynamic', 'SVP_15', 'STSF_CommonAppData',
    'DISPID_SVSCurrentStreamNumber', '_RemotableHandle', 'SPWORDTYPE',
    'ISpeechRecoResult', 'SVP_13', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SBSSeek', 'DISPID_SFSOpen', 'SAFT24kHz16BitStereo',
    'SPSERIALIZEDRESULT', 'SpPhoneConverter',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPPHRASERULE',
    'SVSFUnusedFlags', 'SP_VISEME_6', 'DISPID_SRRTimes',
    'SPWF_SRENGINE', 'Speech_Default_Weight', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE11', 'SpeechPropertyResourceUsage',
    'DISPID_SRGCommit', 'SGDisplay', 'SP_VISEME_3',
    'SPBOOKMARKOPTIONS', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPEAudioSizeBytes',
    'SPPS_RESERVED1', 'DISPID_SpeechPhraseElements', 'SAFTText',
    'DISPID_SGRSTRule', 'DISPID_SPAs_NewEnum', 'DISPID_SGRSTsCount',
    'DISPID_SRCBookmark', 'DISPID_SVResume', 'SDKLCurrentUser',
    'ISpeechObjectTokens', 'SpStream', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechPartOfSpeech', 'SpeechWordType', 'ISpRecoGrammar2',
    'ISpXMLRecoResult', 'DISPID_SRSAudioStatus',
    'IInternetSecurityManager', 'DISPID_SLWType', 'tagSTATSTG',
    'SPWORDPRONUNCIATION', 'SPRS_ACTIVE', 'ISpStream',
    'DISPID_SPIRule', 'SPLEXICONTYPE', 'ISpeechMMSysAudio',
    'SPINTERFERENCE_NOISE', 'DISPID_SpeechObjectTokens',
    'SPSTREAMFORMATTYPE', 'SAFTGSM610_44kHzMono',
    'DISPID_SABIBufferSize', 'DISPID_SRSetPropertyString',
    'SpeechUserTraining', 'DISPID_SDKSetStringValue', 'SPAO_NONE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpUnCompressedLexicon',
    'DISPID_SpeechRecoResult', 'SpeechAudioVolume',
    'SpeechLoadOption', 'DISPID_SRCCreateGrammar', 'SVSFIsXML',
    'DISPID_SPPConfidence', 'SPSHT_NotOverriden',
    'SAFTNonStandardFormat'
]

_check_version('1.1.14', 1619193478.942833)
